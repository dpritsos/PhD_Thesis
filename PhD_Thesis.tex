...
% ----------------------------------------------------------------------------------------------------
%   REQUIREMENT FOR SUPPORTING GREEK LANGUAGE  - REQUIRES PDFXLATEX
% ---------------------------------------------------------------------------------------------------- 
...
\department{\href{http://www.icsd.aegean.gr/icsd/tmima_en}{Dept. of Information and Communication Systems Eng.}} % Your department's name and URL, this is used in the title page and abstract, print it elsewhere with \deptname
\group{\href{http://icsdweb.aegean.gr/ai-lab/}{A.I. Lab}} % Your research group's name and URL, this is used in the title page, print it elsewhere with \groupname
...
\acro{ML}{and Machine Learning}
\acro{AGI}{Automated Genre Identification}
\acro{WGI}{Web Genre Identification}
\acro{URL}{Uniform Resource Locator}
\acro{DOM}{Document Object Model}
\acro{POS}{part-of-speech}
\acro{TF}{Term Frequency}
\acro{TF-IDF}{Term Frequency - Inverted Document Frequency}
\acro{TF-IGF}{Term Frequency - Inverted Genre Frequency}
\acro{OCSVM}{One-Class Support Vector Machines}
\acro{OCSVME}{One-Class Support Vector Machines Ensemble}
\acro{RFSE}{Random Feature Subspacing Ensemble}
\acro{NNDR}{Nearest Neighbors Distance Ratio}
\acro{EAP}{English for Academic Purposes}
\acro{OVIX}{word variation index}
\acro{NR}{nominal ratio}
\acro{LIX}{Lasbarhetsindex}
\acro{HDR}{Harmonic Descriptor Representation}
\acro{mRMR}{Maximally Relevant Minimally Redundant}
\acro{LIWC}{Linguistic Inquiry and Word Count}
\acro{SWT}{Structure-oriented Weighting Technique}
\acro{SVM}{Support Vector Machines}
\acro{MCC}{Multiple Classifier Combination}
\acro{ECC}{Enhanced Centroid-based Classification}
\acro{ITLA}{Iterative Target Language Adaption}
\acro{OSR}{Open Space Risk}
\acro{CD-OSR}{decision-based OSR}
\acro{OCC}{One-Class classification}
\acro{MC}{Mapping Convergence}
\acro{SVMC}{Support Vector Mapping Convergence}
\acro{S-EM}{Spy Expectation Maximization}
\acro{NNO}{Nearest Non-Outlier}
\acro{DRT}{Distance Ratio Threshold}
\acro{TP}{True Positives}
\acro{TN}{True Negatives}
\acro{FP}{False Positives}
\acro{FN}{False Negatives}
\acro{$P_{macro}$}{Macro-averaged Precision score}
\acro{$P_{micro}$}{Micro-averaged Precision score}
\acro{$R_{macro}$}{Macro-averaged Recall score}
\acro{$R_{micro}$}{Micro-averaged Recall score}
\acro{$F1_{macro}$}{Macro-averaged F1 score}
\acro{$F1_{micro}$}{Micro-averaged F1 score}
\acro{PRC}{Precision-Recall Curve}
\acro{AUC}{Area Under the Curve}
\acro{C4G}{Character 4-grams}
\acro{W1G}{Word unigrams}
\acro{W3G}{Word 3-grams}
\acro{POS3G}{Part-of-speech 3-grams}
\acro{BOW}{Bag-of-Words}
\acro{CBOW}{Continuous Bag-of-Words}
\acro{PV-DV}{Paragraph Vector - Distributed Memory}
\acro{PV-DBOW}{Paragraph Vector - Distributed Bag-of-Words}
\acro{DF}{Distributed Features}
