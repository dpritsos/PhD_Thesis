...
\acro{$P_{macro}$}{Macro Precision score}
\acro{$P_{micro}$}{Micro Precision score}
\acro{$R_{macro}$}{Macro Recall score}
\acro{$R_{micro}$}{Micro Recall score}
\acro{$F1_{macro}$}{Macro F1 score}
\acro{$F1_{micro}$}{Micro F1 score}
