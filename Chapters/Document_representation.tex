...
\section{Terms N-grams vs Word Embedding}{chap:word_embedding:sec:ngrans_vs_doc2vec}


\section{Word Embedding for Improving Low Performance Learners on WGI}{chap:word_embedding:sec:all_algorithms_test_with_doc2vec}


\section{Random Features vs Word Embedding for the Open-set Framework}{chap:word_embedding:sec:last_paper_presentation}



\section{Distributional Features Learning}\label{chap:word_embedding:sec:word_embedding}
