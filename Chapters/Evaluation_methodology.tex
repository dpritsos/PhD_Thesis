...
\begin{table}[t]
	...
	\begin{tabular}{c c c c c}
		...
		\hline
		\multicolumn{1}{|c}{Macro($\mathcal{C}$)} & \multicolumn{1}{|c}{0.625} & \multicolumn{1}{c|}{0.XXX} & 0.499 & \multicolumn{1}{c|}{0.XXX}\\
		\multicolumn{1}{|c}{Micro($\mathcal{C}$)} & \multicolumn{1}{|c}{0.986} & \multicolumn{1}{c|}{0.XXX} & 0.999 & \multicolumn{1}{c|}{0.XXX}\\
		\hline
		\multicolumn{1}{|c}{Macro($\mathcal{C} \cup \emptyset$)} & \multicolumn{1}{|c}{0.612} & \multicolumn{1}{c|}{0.XXX} & 0.507 & \multicolumn{1}{c|}{0.XXX}\\	
		\multicolumn{1}{|c}{Micro($\mathcal{C} \cup \emptyset$)} & \multicolumn{1}{|c}{0.986} & \multicolumn{1}{c|}{0.XXX} & 0.930 & \multicolumn{1}{c|}{0.XXX}\\
		\hline
	\end{tabular}
\end{table}
