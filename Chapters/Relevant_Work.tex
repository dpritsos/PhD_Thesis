...
This is the case of the \textit{Distributional Features Modeling} where it is discussed in section \ref{chap:Document_Representation} and it is shown how a week ML algorithm can be trained with 100 times less features than the features given to an better algorithm for the WGI task.
...
Different modulates, including plain-text, web-texts, ans image/scanned-texts
...
\section{Deep Learning Vocabulary of Distributional Features for WGI and WGC}\label{chap:relevant_work:sec:word_embedding}


Recently deep learning methods have also been tested in genre detection setups with promising results \parencite{worsham2018genre}. 
