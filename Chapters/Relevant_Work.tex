...
\begin{itemize}
    ...
    \item LWGC-R: This is based on the same methodology with LWGC-B. However, a random collection of web-pages was assigned to genres meaning that it is highly unblalanced. In addition, a large part (almost half) of web-pages do not belong to any of the given genres (i.e., noise) \parencite{Asheghi:2015c}.
\end{itemize}
