...
Finally several weighing schemes were used such as binary, TF or the one described in equation \ref{eq:jebary_url_weigh_cngrams_1} and \ref{eq:jebary_url_weigh_cngrams_2}. 
