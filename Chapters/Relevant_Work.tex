...
Domain transfer: The ability to transfer across multiple-topic domains. 

Investigate the effect of topic on AGI. Particularly in respect of features used for the classification task.
...
early fusion 
Για το paper από πάνω.

late fusion
 Για το paper που διαβάζω τώρα
